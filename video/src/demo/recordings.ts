 ...
 * the web hero uses only the 64-col takes; the export composition also
...
import claudeHandoffJson from "../assets/terminal/claude-handoff.grid.json";
...
/** 64x14 Claude Code two-turn take: fix, then a follow-up (landing hero). */
export const claudeHandoff = claudeHandoffJson as unknown as GridTimeline;

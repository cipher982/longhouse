...
smoke-prod-full: ## Production smoke test with LLM/voice (~60s)
	@./scripts/smoke-prod.sh --wait --full

test-e2e-prod: ## Run E2E against production (requires SMOKE_TEST_SECRET)

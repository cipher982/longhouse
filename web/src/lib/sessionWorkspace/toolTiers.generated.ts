...
export const TOOL_TIERS: Record<string, ToolTierMeta> = {
  ...
  "exec_command": { tier: "action", aggregate: null, icon: "$", label: "Shell", color: "warning" },
  ...
  "apply_patch": { tier: "action", aggregate: null, icon: "E", label: "Edited", color: "brand" },
  ...
  "exec": { tier: "action", aggregate: null, icon: "$", label: "Shell", color: "warning" },

 ...
 *
 * Storage key: "longhouse:inbox-order:v1".
 */
...
const empty: InboxOrderState = { repoOrder: [], sessionOrder: {} };
...
export function readInboxOrder(): InboxOrderState {
  ...
  try {
    ...
    return {
      repoOrder: Array.isArray(parsed.repoOrder) ? parsed.repoOrder.filter((s) => typeof s === "string") : [],

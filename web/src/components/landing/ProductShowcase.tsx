...
const tabs: TabConfig[] = [
  {
    id: "timeline",
    label: "Timeline",
    description: "The bundled human view of the kernel. See the durable session archive across providers.",
  ...
  },
  {
    id: "search",
    label: "Search",
    description: "Recover the prior solution fast by searching transcripts, tool calls, and edits in one place.",
  ...
  },
  {
    ...
    description: "Inspect the raw detail that matters: transcript, tool history, and the exact point to continue from.",

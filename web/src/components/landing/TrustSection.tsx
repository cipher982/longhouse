...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Claude Code currently has the strongest continuation path, hooks, and telemetry. Codex CLI and Gemini CLI are already findable and inspectable in the timeline, but continuation is still Claude-first. OpenCode and Cursor are coming soon."
  }
];

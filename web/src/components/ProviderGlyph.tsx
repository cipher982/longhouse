...
function GeminiMark({ gradientId }: { gradientId: string }) {
  return (
...
function MarkFor(provider: string, gradientId: string) {
  switch (provider) {
    case "codex":
    case "openai":
      return <OpenAIMark />;
    case "claude":
      return <ClaudeMark />;
    case "gemini":
      return <GeminiMark gradientId={gradientId} />;
    case "opencode":
      return <OpenCodeMark />;
    case "antigravity":

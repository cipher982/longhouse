...
/** OpenAI / Codex — monochrome knot mark (simple-icons). Single path, uses currentColor. */
function OpenAIMark() {
  return (
...
/** Claude — terracotta sunburst (simple-icons). Single path, uses currentColor. */
function ClaudeMark() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false">
...
/** Antigravity — Google's arch mark, monochrome variant (lobehub icons). */

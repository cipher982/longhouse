...
const seamItem: TimelineItem = {
  ...
  seam: {
    ...
    description: "Synced Cinder history above. Cloud-native messages below.",
...
describe("TimelinePane", () => {
  it("renders seam items inline in the timeline list", () => {
    ...
    expect(screen.getByText("Cloud continuation begins")).toBeInTheDocument();
    expect(screen.getByText("Synced Cinder history above. Cloud-native messages below.")).toBeInTheDocument();

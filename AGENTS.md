...
- (2026-02-05) [ops] Prod health logs show Alembic upgrade failing on missing revision `20260131_llm_audit` (PostgresqlImpl despite SQLite URL) but server starts; needs migration fix.

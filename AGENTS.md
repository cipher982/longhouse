...
- (2026-01-31) [gotcha] config.Settings.db_is_sqlite() only checks startswith("sqlite") and ignores quoted DATABASE_URL; can mis-detect lite_mode vs database._is_sqlite_url.

...
- `needs_user` is often the provider's normal idle prompt after an assistant response, not durable unfinished work. Mobile/top-shelf attention must stay freshness-bound and lifecycle-aware; do not treat stale `needs_user` like `blocked`.

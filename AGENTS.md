...
- For managed Codex upstream-watch automation, GitHub `releases/latest` only covers the latest published full release; use the releases list or tags when prereleases matter.

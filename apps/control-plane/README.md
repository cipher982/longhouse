...
CONTROL_PLANE_INSTANCE_GMAIL_PUBSUB_TOPIC=projects/<project>/topics/<topic>
CONTROL_PLANE_INSTANCE_PUBSUB_SA_EMAIL=pubsub-push@<project>.iam.gserviceaccount.com
CONTROL_PLANE_GOOGLE_CLOUD_CREDENTIALS_JSON=...  # optional if ADC / GOOGLE_APPLICATION_CREDENTIALS is unavailable

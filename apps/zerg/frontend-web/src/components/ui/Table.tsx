...
export const Table: React.FC<TableProps> & {
  ...
  Row: React.FC<{ children: React.ReactNode; className?: string; onClick?: () => void; onKeyDown?: (e: React.KeyboardEvent<HTMLTableRowElement>) => void; style?: React.CSSProperties; 'data-fiche-id'?: number }>;

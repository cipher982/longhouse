    ...
    >
      <defs>
        ...
        <pattern id="stripes" patternUnits="userSpaceOnUse" width="6" height="3">
          <rect width="6" height="1.5" fill="#5D9B4A" />
      ...
      <path d="M100 30 Q100 60 100 80" stroke="#5C4F3D" strokeWidth="2.5" fill="none" />
      <path d="M60 50 Q80 70 100 80" stroke="#5C4F3D" strokeWidth="2" fill="none" />
      <path d="M140 50 Q120 70 100 80" stroke="#5C4F3D" strokeWidth="2" fill="none" />
      ...
      {/* Bottom panel lines */}
      <path d="M70 150 Q100 165 130 150" stroke="#5C4F3D" strokeWidth="2" fill="none" />
      ...
      {/* Swarm icon - top (head) */}
      <g filter="url(#glow)">
        <ellipse cx="100" cy="88" rx="10" ry="8" fill="#5D9B4A" mask="url(#stripeMask)" />
        <ellipse
          cx="100"
          cy="88"
          rx="10"
      ...
      <g filter="url(#glow)">
        <ellipse cx="78" cy="112" rx="12" ry="10" fill="#5D9B4A" mask="url(#stripeMask)" />
        <ellipse
          cx="78"
          cy="112"
          rx="12"
      ...
      <g filter="url(#glow)">
        <ellipse cx="122" cy="112" rx="12" ry="10" fill="#5D9B4A" mask="url(#stripeMask)" />
        <ellipse
          cx="122"
          cy="112"
          rx="12"
      ...
      <g stroke="#5D9B4A" strokeWidth="1.5" opacity="0.6" filter="url(#glow)">

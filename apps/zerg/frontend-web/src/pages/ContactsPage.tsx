...
export default function ContactsPage() {
  ...
  const handleDelete = async (contact: EmailContact | PhoneContact, type: "email" | "phone") => {
    const confirmed = await confirm({
      ...
      message:
        type === "email"
          ? "Your automations will no longer be able to send emails to this contact."
          : "Your automations will no longer be able to send SMS to this contact.",
      confirmLabel: "Remove",
      cancelLabel: "Keep",
      variant: "danger",
    });
  ...
  return (
    <PageShell size="narrow" className="contacts-page-container">
      <SectionHeader
        ...
        description="Manage contacts that your automations can send emails or SMS to. Automations can only contact people on this list."
      />
          ...
          <div className="contacts-section">
            ...
            {emailContacts && emailContacts.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Add contacts to let your automations send emails on your behalf."
              />
            )}
          </div>
        ) : (
          <div className="contacts-section">
            ...
            {phoneContacts && phoneContacts.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Add contacts to let your automations send SMS on your behalf."
              />
            )}
          </div>
        )}

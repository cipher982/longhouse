/**
 * Application state types for Oikos PWA
 */
...
export interface ChatMessage {
  ...
  itemId?: string
  /** New fields for Option C (Oikos Typing Indicator) */
  status?: AssistantStatus
  /**
   * Unique identifier for the assistant message.
   * For normal runs: Client-generated upfront (no binding step needed).
   * For continuation runs: Backend-generated, received in oikos_started event.
   * Stable across oikos_started -> oikos_token -> oikos_complete.
   */
  messageId?: string
  /** Oikos run ID for associating tool calls with this message */
  runId?: number

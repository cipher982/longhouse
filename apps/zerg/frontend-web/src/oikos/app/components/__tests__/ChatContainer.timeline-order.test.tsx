...
describe('ChatContainer timeline ordering', () => {
  ...
  it('keeps spawn_workspace_commis card between user and assistant during streaming', () => {
    ...
    // Directly add tool to store (simulates oikos_tool_started event)
    // Access internal state for test setup
    const toolState = oikosToolStore.getState();

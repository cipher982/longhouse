 ...
 * Centralizes global state management for Oikos PWA
 */
...
export class StateManager {
   ...
   * Update Oikos client
   */
  setOikosClient(client: OikosAPIClient | null): void {
    this.state.oikosClient = client;
  }
   ...
   * Get Oikos client
   */
  getOikosClient(): OikosAPIClient | null {
    return this.state.oikosClient;
  }

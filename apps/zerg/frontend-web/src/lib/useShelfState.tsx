...
/**
 * Shared mobile drawer state for the chat thread sidebar.
 *
 * DESIGN NOTE: This uses a single `isShelfOpen` boolean for the chat sidebar.
 * If we add additional drawers later, consider splitting into separate state
 * keys per feature.
 */

...
cat > "$CSP_FILE" << EOF
add_header Content-Security-Policy "default-src 'self'; base-uri 'self'; frame-ancestors 'self'; object-src 'none'; connect-src $CONNECT_SRC; script-src 'self' https://accounts.google.com https://analytics.drose.io https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://accounts.google.com https://fonts.googleapis.com https://api.fontshare.com; font-src 'self' https://fonts.gstatic.com https://cdn.fontshare.com; img-src 'self' data: https: blob:; media-src 'self' blob: data:; frame-src https://accounts.google.com;" always;
EOF

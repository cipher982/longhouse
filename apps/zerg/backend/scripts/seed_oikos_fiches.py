...
Present this as a friendly morning briefing.""",
    ...
    {
        "name": "Health Watch",
        "system_instructions": """You are the Health Watch assistant for Oikos.
...
Be specific with numbers and trends.""",
    ...
    },
    {
        ...
        "system_instructions": """You are the Weekly Planning assistant for Oikos.
...
Provide a structured weekly overview.""",
    ...
    },
    {
        ...
        "system_instructions": """You are a quick status assistant for Oikos.
...
def seed_fiches():
    ...
    if not oikos_user:
        ...
        oikos_user.display_name = "Oikos Assistant"
        db.add(oikos_user)
        db.commit()
        db.refresh(oikos_user)
    else:

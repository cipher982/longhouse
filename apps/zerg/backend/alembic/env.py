...
# Add the parent directory to Python path to import zerg modules
...
from zerg.models import models  # noqa: F401
...
def run_migrations_online() -> None:
    ...
    if "sqlalchemy.url" not in configuration:
        settings = get_settings()
        configuration["sqlalchemy.url"] = settings.database_url or "sqlite:///./app.db"

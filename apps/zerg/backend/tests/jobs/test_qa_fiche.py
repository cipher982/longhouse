...
from zerg.jobs.qa.qa_fiche import _parse_fiche_state
from zerg.jobs.qa.qa_fiche import collect_health_data


class TestParseFicheState:
    """Tests for parsing fiche output."""
...
'''
    ...
    def test_empty_output_returns_default(self):
        ...
        result, parse_ok = _parse_fiche_state("")
    ...
    def test_invalid_json_returns_default(self):
        ...
        result, parse_ok = _parse_fiche_state("This is not JSON at all")
    ...
    def test_preserves_default_fields(self):
        """Should preserve default fields when not in fiche output."""
...
class TestIssueLifecycle:
    ...
    def test_new_issue_from_clean_state(self):
        ...
        # Simulating what the fiche should produce
        expected_issue = {
            "fingerprint": "error_rate_high",
            "status": "open",
            "consecutive": 1,
    ...
    def test_chronic_after_three_consecutive(self):
        ...
        issue = {
            ...
            "consecutive": 3,
            "occurrences": 3,
            "chronic": True,  # Fiche should set this
        }
        assert issue["chronic"] is True


class TestConfig:
    """Tests for QA fiche configuration."""
...
class TestFetchPreviousState:
    ...
    async def test_handles_dict_from_asyncpg(self):
        ...
        from zerg.jobs.qa.qa_fiche import _fetch_previous_qa_state
...
class TestAgentFailureHandling:
    """Tests for handling fiche analysis failures."""
    ...
    async def test_fiche_failure_preserves_previous_state(self):
        ...
        with patch("zerg.jobs.qa.qa_fiche._fetch_previous_qa_state", return_value=previous_state):
            with patch("zerg.jobs.qa.qa_fiche._run_collect_script", return_value={"success": True, "status": "ok"}):
                with patch(
                    "zerg.jobs.qa.qa_fiche._run_fiche_analysis",
        ...
        assert result["fiche_status"] == "cli_not_found"
        # Should record the error
        assert "fiche_error" in result["qa_state"]

...
class ConnectorStatusResponse(BaseModel):
    ...
    category: str = Field(..., description="Category: 'notifications', 'project_management', or 'infrastructure'")
    ...
    enabled_tools: list[str] = Field(default_factory=list, description="Tools enabled by this connector")

"""Web implementation of the SurfaceAdapter contract."""
...
class WebSurfaceAdapter:
    """Adapter for browser chat ingress via `/api/oikos/chat`."""
    ...
    async def normalize_inbound(self, raw_input: Any) -> SurfaceInboundEvent | None:
        ...
        conversation_id = str(payload.get("conversation_id", "") or "web:main")
        dedupe_key = f"web:{owner_hint}:{message_id}"

"""Oikos TTS Router - Text-to-Speech endpoints for voice responses.

Provides:
- POST /api/oikos/tts - Convert text to speech
- GET /api/oikos/tts/stream - Stream audio generation
- GET /api/oikos/tts/status - Get TTS configuration status
- GET /api/oikos/tts/voices - List available voices
"""
...
router = APIRouter(tags=["oikos-tts"])

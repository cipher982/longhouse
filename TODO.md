...
- 2026-03-17: Current slice: finish the remaining browser-facing automation naming drift in the frontend app itself (copy, type aliases, hooks/modules) while keeping backend/storage contracts stable.

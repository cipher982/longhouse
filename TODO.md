...
- Video demo: capture scroll now targets page-shell; timeline scene 1 uses hover selectors for stability.
- Demo seeding/dev: FTS rebuild helper + explicit commit; dev scripts set Vite proxy to local backend.

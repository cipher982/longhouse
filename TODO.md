...
- [Managed-local native Codex](docs/tasks/open/managed-local-native-codex.md) — native UI path via app-server + hooks, approval handling, away-mode parity, tmux fallback only.

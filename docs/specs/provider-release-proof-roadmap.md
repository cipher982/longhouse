...
**Current grand-epic score:** 57/100
...
movement for this epic is release-watch proofing before/after: roughly 20 -> 57.
...
| H13 | Migrate control/live-token/tool/resume scenarios | Partial | +8 | `control_surface` now exposes comparable control/observe action rows; real live-token/control migrations remain future work |
...
5. Migrate remaining `resume_reattach` and control-plane send/interrupt evidence
   behind universal scenarios.

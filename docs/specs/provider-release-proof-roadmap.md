...
**Current grand-epic score:** 87/100
...
movement for this epic is release-watch proofing before/after: roughly 20 -> 87.
...
- `resume_reattach` is now an executable universal scenario. OpenCode routes it
  ...
  without those credentials it reports the typed credentials gap. Claude and
  Antigravity still return typed adapter gaps.

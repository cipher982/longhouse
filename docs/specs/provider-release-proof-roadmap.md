...
- `resume_reattach` is now an executable universal scenario. OpenCode routes it
  ...
  without those credentials it reports the typed credentials gap. Claude proves
  the channel resume command shape hermetically, including `--resume`,

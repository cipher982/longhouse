...
- Longhouse is the timeline, search, and continuation product for CLI sessions.
...
- Launch-facing docs/UI describe provider support consistently with the real runtime.

...
class Instance(Base):
    ...
    # Tracks when the most recent provisioning attempt started (set by _recreate_instance
    # and create_instance). Used by the reconciler to timeout stuck provisioning without
    # falsely triggering on old instances that just got reprovisioned.

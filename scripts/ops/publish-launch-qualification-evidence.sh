...
# qualification lane. This is intentionally an operator-side transfer: the
# GitHub-hosted signer never accepts a report whose source/artifact provenance
# was not regenerated by the measured checkout.

SOURCE_SHA="${1:-}"
INPUT_ROOT="${2:-}"
REMOTE_HOST="${LONGHOUSE_QUALIFICATION_HOST:-cube}"
REMOTE_ROOT="${LONGHOUSE_QUALIFICATION_ROOT:-/var/lib/longhouse/qualification}"

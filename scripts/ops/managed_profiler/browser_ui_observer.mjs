  ...
  try {
    ...
    return values
      ...
      .map((value) => ({
        ...
        clock_sync_rtt_ms: value.clock_sync_rtt_ms ?? null,
        clock_sync_uncertainty_ms: value.clock_sync_uncertainty_ms ?? null,
        clock_sync_sample_count: value.clock_sync_sample_count ?? null,

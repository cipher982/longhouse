...
DEFAULT_INVENTORY: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "owner_area": "claude-native",
        "replacement_phase": "phase3",
        "reason": "Python still owns the Claude channel MCP server and compatibility bridge commands.",
        "device_command": True,
    ...
    },
    {
        ...
        "owner_area": "claude-native",
        "replacement_phase": "phase3",
        "reason": "Python still backs human-launch command construction and channel config helper behavior.",
        "device_command": True,
        "python_dependency_kind": "control_shellout",
    },
    {

...
DEFAULT_INVENTORY: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "owner_area": "claude-native",
        "replacement_phase": "phase3",
        "reason": "Python still owns compatibility claude-channel CLI commands for human/local use.",
        "device_command": True,
    ...
    },
    {
        ...
        "owner_area": "claude-native",
        "replacement_phase": "phase3",
        "reason": "Python still backs human-launch command construction and compatibility channel config helper behavior.",
        "device_command": True,
        "python_dependency_kind": "control_shellout",
    },
    {

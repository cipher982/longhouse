...
struct SessionStreamResumeTests {
    ...
    func visiblePollPolicyCoversDisconnectedRunningToolAndManagedBackstop() {
        ...
        #expect(SessionViewModel.shouldPollVisibleSession(connected: false, hasRunningTool: false, managed: false, setupPending: true, ticks: 30))
        #expect(SessionViewModel.shouldPollVisibleSession(connected: true, hasRunningTool: false, managed: false, pendingInput: true, ticks: 28))
        ...
        #expect(SessionViewModel.shouldPollVisibleSession(connected: false, hasRunningTool: false, managed: false, pendingInput: true, ticks: 30))

...
public enum ToolTiers {
    ...
    public static let tools: [String: ToolTierMeta] = [
        ...
        "exec_command": ToolTierMeta(tier: .action, aggregate: nil, icon: "$", label: "Shell", color: .warning),
        ...
        "apply_patch": ToolTierMeta(tier: .action, aggregate: nil, icon: "E", label: "Edited", color: .brand),
        ...
        "exec": ToolTierMeta(tier: .action, aggregate: nil, icon: "$", label: "Shell", color: .warning),

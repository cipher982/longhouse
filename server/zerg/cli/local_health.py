...
def _render_snapshot(snapshot: dict[str, object], *, json_output: bool) -> None:
    ...
    if control_channel:
        ...
        console_ready = ", ".join(control_channel.get("console_ready_providers") or []) or "-"
        typer.echo(f"  Console providers: {console_ready}")
        ...
        if control_channel.get("console_blocked_by"):
            typer.echo(f"  Console blocked by: {control_channel['console_blocked_by']}")

...
Account-level credentials are shared across all automations owned by the user.
Individual automations can still override them with automation-specific credentials.

...
def test_local_health_render_prints_archive_backlog_distribution(capsys):
                ...
                "payload": {
                    ...
                    "adaptive_backlog_limiter": {
                        ...
                        "last_observed_store_stage_ms": {
                            "total": 180.0,
                            "provider_event_observations": 75.0,
                            "source_line_observations": 40.0,
                        },
    ...
    assert (
        "host store stages: total 180 ms, provider_event_observations 75.0 ms, source_line_observations 40.0 ms"
        in output
    )
...
def test_collect_local_health_fast_uses_resolved_sessions_without_process_scan(monkeypatch, tmp_path: Path):
            ...
            "sessions": [
                {
                    ...
                    "first_user_message": "Fix fast menu titles without networking",
                    "title_state": "ready",
                    "title_source": "prompt",
                    "workspace": {
                        "cwd": "/Users/test/git/zerg",
    ...
    assert snapshot["managed_sessions"][0]["title_source"] == "prompt"
        ...
        json.dumps(
            {
                ...
                "failure_count": 0,
                "providers": ["opencode"],
                "results": [{"provider": "opencode", "status": "pass"}],
            }
        ),
        encoding="utf-8",
    )

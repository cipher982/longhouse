...
def test_claude_ask_user_question_transcript_creates_read_only_pause_request(tmp_path):
    ...
    with SessionLocal() as db:
        ...
        assert projection["summary"] == "Waiting for an answer in the original terminal."
